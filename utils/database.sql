...
CREATE POLICY IF NOT EXISTS patients_access_policy ON public.patients
  USING (true) 
  WITH CHECK (true);
...
CREATE POLICY IF NOT EXISTS emergencies_access_policy ON public.emergencies
  USING (true) 
  WITH CHECK (true);
